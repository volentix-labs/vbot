        ...
        if(!developers.includes(name)) {
            ...
            if (servicename === 'ui') {
                ...
                (async () => {
                    ...
                    serverDeployment.spec.template.spec.containers[0].env[1].value = "https://venue-uat.volentix.io";
                    serverDeployment.spec.template.spec.containers[0].env[2].value = "https://venue-uat.volentix.io";
                    ...
                    serverDeployment.spec.template.spec.containers[0].env[1].value = "https://venue-perf.volentix.io";
                    serverDeployment.spec.template.spec.containers[0].env[2].value = "https://venue-perf.volentix.io";
